...
3. rw: fio pattern (example: randwrite)
...
7. btrfs_kernel_module_path: path to btrfs.ko

8. size: fio --size in GiB (script appends G)

9. io_size: fio --io_size in GiB (script appends G)

10. run: either base or nodatasum
